...
PHP_METHOD(php_wxPlatformInfo, GetArch)
{
    ...
    if(!already_called && arguments_received == 1)
    {
        ...
        char parse_parameters_string[] = "s";
        if(zend_parse_parameters_ex(ZEND_PARSE_PARAMS_QUIET, arguments_received, parse_parameters_string, &arch0, &arch_len0 ) == SUCCESS)
        {
            overload0_called = true;
            already_called = true;
        }
...
PHP_METHOD(php_wxPlatformInfo, GetArchName)
{
    ...
    if(getThis() != NULL)
    {
        ...
        if(current_object->native_object == NULL)
        {
            zend_error(
                E_ERROR,
                "Failed to get the native object for "
                "wxPlatformInfo::GetArchName call\n"
            );
    ...
    if(!already_called && arguments_received == 1)
    {
        ...
        char parse_parameters_string[] = "l";
        if(zend_parse_parameters_ex(ZEND_PARSE_PARAMS_QUIET, arguments_received, parse_parameters_string, &arch1 ) == SUCCESS)
        {
            overload1_called = true;
            already_called = true;
        }
    ...
    if(getThis() != NULL)
    {
        ...
        if(current_object->native_object == NULL)
        {
            zend_error(
                E_ERROR,
                "Failed to get the native object for "
                "wxPlatformInfo::GetArchitecture call\n"
            );
...
/* {{{ proto wxLinuxDistributionInfo wxPlatformInfo::GetLinuxDistributionInfo()
...
{
    #ifdef USE_WXPHP_DEBUG
    php_printf("Invoking wxPlatformInfo::GetLinuxDistributionInfo\n");
    php_printf("===========================================\n");
    #endif
    ...
    if(getThis() != NULL)
    {
        ...
        if(current_object->native_object == NULL)
        {
            zend_error(
                E_ERROR,
                "Failed to get the native object for "
                "wxPlatformInfo::GetLinuxDistributionInfo call\n"
            );
    ...
    if(overload0_called)
    {
        switch(arguments_received)
        {
            ...
            {
                #ifdef USE_WXPHP_DEBUG
                php_printf("Executing wxPlatformInfo::GetLinuxDistributionInfo() to return new object\n\n");
                #endif

                wxLinuxDistributionInfo value_to_return0;
                value_to_return0 = ((wxPlatformInfo_php*)native_object)->GetLinuxDistributionInfo();
    ...
    if(!already_called)
    {
        zend_error(
            E_ERROR,
            "Wrong type or count of parameters passed to: "
            "wxPlatformInfo::GetLinuxDistributionInfo\n"
        );
    }
}
/* }}} */
    ...
    if(getThis() != NULL)
    {
        ...
        if(current_object->native_object == NULL)
        {
            zend_error(
                E_ERROR,
                "Failed to get the native object for "
                "wxPlatformInfo::SetArchitecture call\n"
            );
