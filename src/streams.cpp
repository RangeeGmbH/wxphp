...
BEGIN_EXTERN_C()
void php_wxTextInputStream_free(void *object)
{
    zo_wxTextInputStream* custom_object = (zo_wxTextInputStream*) object;

    #ifdef USE_WXPHP_DEBUG
    php_printf(
        "Calling php_wxTextInputStream_free on %s at line %i\n",
        zend_get_executed_filename(),
        zend_get_executed_lineno()
    );
    php_printf("===========================================\n");
    ...
    if(custom_object->native_object != NULL)
    {
        ...
        #ifdef USE_WXPHP_DEBUG
        php_printf("Deletion of wxTextInputStream done\n");
        php_printf("===========================================\n\n");
        #endif
    }
    else
...
zend_object* php_wxTextInputStream_new(zend_class_entry *class_type)
{
    #ifdef USE_WXPHP_DEBUG
    php_printf(
        "Calling php_wxTextInputStream_new on %s at line %i\n",
        zend_get_executed_filename(),
        zend_get_executed_lineno()
    );
    php_printf("===========================================\n");
    ...
    zo_wxTextInputStream* custom_object;

    custom_object = (zo_wxTextInputStream*) ecalloc(
        1,
        sizeof(zo_wxTextInputStream)
        + zend_object_properties_size(class_type)
    );
    ...
    custom_object->zo.handlers = &wxphp_wxTextInputStream_object_handlers;

    custom_object->native_object = NULL;
    custom_object->object_type = PHP_WXTEXTINPUTSTREAM_TYPE;
    custom_object->is_user_initialized = 0;
...
/* {{{ proto wxInputStream wxTextInputStream::GetInputStream() */
PHP_METHOD(php_wxTextInputStream, GetInputStream)
{
    #ifdef USE_WXPHP_DEBUG
    php_printf("Invoking wxTextInputStream::GetInputStream\n");
    php_printf("===========================================\n");
    #endif

    zo_wxTextInputStream* current_object;
    wxphp_object_type current_object_type;
    wxTextInputStream_php* native_object;
    void* argument_native_object = NULL;
    ...
    if(getThis() != NULL)
    {
        current_object = Z_wxTextInputStream_P(getThis());
        ...
        if(current_object->native_object == NULL)
        {
            zend_error(
                E_ERROR,
                "Failed to get the native object for "
                "wxTextInputStream::GetInputStream call\n"
            );
        ...
        else
        {
            ...
            if(current_object_type == PHP_WXTEXTINPUTSTREAM_TYPE){
                references = &((wxTextInputStream_php*)native_object)->references;
                reference_type_found = true;
            }
        }
    }
    ...
    if(overload0_called)
    {
        switch(arguments_received)
        {
            ...
            {
                #ifdef USE_WXPHP_DEBUG
                php_printf("Executing wxTextInputStream::GetInputStream() to return object reference\n\n");
                #endif

                wxInputStream_php* value_to_return0;
                if(current_object_type == PHP_WXTEXTINPUTSTREAM_TYPE)
                {
                    value_to_return0 = (wxInputStream_php*) &((wxTextInputStream_php*)native_object)->GetInputStream();
                ...
                if((void*)value_to_return0 != (void*)native_object && return_is_user_initialized){ //Prevent adding references to it self
                    references->AddReference(return_value, "wxTextInputStream::GetInputStream at call 6 with 0 argument(s)");
                }
    ...
    if(!already_called)
    {
        zend_error(
            E_ERROR,
            "Wrong type or count of parameters passed to: "
            "wxTextInputStream::GetInputStream\n"
        );
    }
}
/* }}} */

/* {{{ proto int wxTextInputStream::Read16(int base) */
PHP_METHOD(php_wxTextInputStream, Read16)
{
    #ifdef USE_WXPHP_DEBUG
    php_printf("Invoking wxTextInputStream::Read16\n");
    php_printf("===========================================\n");
    #endif
    ...
    if(!already_called && arguments_received >= 0  && arguments_received <= 1)
    {
        #ifdef USE_WXPHP_DEBUG
        php_printf("Parameters received %d\n", arguments_received);
        php_printf("Parsing parameters with '|l' (&base0)\n");
        #endif

        char parse_parameters_string[] = "|l";
        if(zend_parse_parameters_ex(ZEND_PARSE_PARAMS_QUIET, arguments_received, parse_parameters_string, &base0 ) == SUCCESS)
        {
            overload0_called = true;
            already_called = true;
        }
    ...
    if(overload0_called)
    {
        switch(arguments_received)
        {
            ...
            {
                #ifdef USE_WXPHP_DEBUG
                php_printf("Executing RETURN_LONG(wxTextInputStream::Read16())\n\n");
                #endif

                if(current_object_type == PHP_WXTEXTINPUTSTREAM_TYPE)
                {
                    RETVAL_LONG(((wxTextInputStream_php*)native_object)->Read16());
                }
            ...
            {
                #ifdef USE_WXPHP_DEBUG
                php_printf("Executing RETURN_LONG(wxTextInputStream::Read16((int) base0))\n\n");
                #endif

                if(current_object_type == PHP_WXTEXTINPUTSTREAM_TYPE)
                {
                    RETVAL_LONG(((wxTextInputStream_php*)native_object)->Read16((int) base0));
                }
...
/* {{{ proto int wxTextInputStream::Read32(int base) */
PHP_METHOD(php_wxTextInputStream, Read32)
{
    #ifdef USE_WXPHP_DEBUG
    php_printf("Invoking wxTextInputStream::Read32\n");
    php_printf("===========================================\n");
    #endif
    ...
    if(overload0_called)
    {
        switch(arguments_received)
        {
            ...
            {
                #ifdef USE_WXPHP_DEBUG
                php_printf("Executing RETURN_LONG(wxTextInputStream::Read32())\n\n");
                #endif

                if(current_object_type == PHP_WXTEXTINPUTSTREAM_TYPE)
                {
                    RETVAL_LONG(((wxTextInputStream_php*)native_object)->Read32());
                }
            ...
            {
                #ifdef USE_WXPHP_DEBUG
                php_printf("Executing RETURN_LONG(wxTextInputStream::Read32((int) base0))\n\n");
                #endif

                if(current_object_type == PHP_WXTEXTINPUTSTREAM_TYPE)
                {
                    RETVAL_LONG(((wxTextInputStream_php*)native_object)->Read32((int) base0));
                }
...
/* {{{ proto int wxTextInputStream::Read32S(int base) */
PHP_METHOD(php_wxTextInputStream, Read32S)
{
    #ifdef USE_WXPHP_DEBUG
    php_printf("Invoking wxTextInputStream::Read32S\n");
    php_printf("===========================================\n");
    #endif
    ...
    if(getThis() != NULL)
    {
        ...
        if(current_object->native_object == NULL)
        {
            zend_error(
                E_ERROR,
                "Failed to get the native object for "
                "wxTextInputStream::Read32S call\n"
            );
    ...
    if(overload0_called)
    {
        switch(arguments_received)
        {
            ...
            {
                #ifdef USE_WXPHP_DEBUG
                php_printf("Executing RETURN_LONG(wxTextInputStream::Read32S())\n\n");
                #endif

                if(current_object_type == PHP_WXTEXTINPUTSTREAM_TYPE)
                {
                    RETVAL_LONG(((wxTextInputStream_php*)native_object)->Read32S());
                }
            ...
            {
                #ifdef USE_WXPHP_DEBUG
                php_printf("Executing RETURN_LONG(wxTextInputStream::Read32S((int) base0))\n\n");
                #endif

                if(current_object_type == PHP_WXTEXTINPUTSTREAM_TYPE)
                {
                    RETVAL_LONG(((wxTextInputStream_php*)native_object)->Read32S((int) base0));
                }
...
/* {{{ proto int wxTextInputStream::Read8(int base) */
PHP_METHOD(php_wxTextInputStream, Read8)
{
    #ifdef USE_WXPHP_DEBUG
    php_printf("Invoking wxTextInputStream::Read8\n");
    php_printf("===========================================\n");
    #endif
    ...
    if(overload0_called)
    {
        switch(arguments_received)
        {
            ...
            {
                #ifdef USE_WXPHP_DEBUG
                php_printf("Executing RETURN_LONG(wxTextInputStream::Read8())\n\n");
                #endif

                if(current_object_type == PHP_WXTEXTINPUTSTREAM_TYPE)
                {
                    RETVAL_LONG(((wxTextInputStream_php*)native_object)->Read8());
                }
            ...
            {
                #ifdef USE_WXPHP_DEBUG
                php_printf("Executing RETURN_LONG(wxTextInputStream::Read8((int) base0))\n\n");
                #endif

                if(current_object_type == PHP_WXTEXTINPUTSTREAM_TYPE)
                {
                    RETVAL_LONG(((wxTextInputStream_php*)native_object)->Read8((int) base0));
                }
...
/* {{{ proto float wxTextInputStream::ReadDouble() */
PHP_METHOD(php_wxTextInputStream, ReadDouble)
{
    #ifdef USE_WXPHP_DEBUG
    php_printf("Invoking wxTextInputStream::ReadDouble\n");
    php_printf("===========================================\n");
    #endif
    ...
    if(getThis() != NULL)
    {
        ...
        if(current_object->native_object == NULL)
        {
            zend_error(
                E_ERROR,
                "Failed to get the native object for "
                "wxTextInputStream::ReadDouble call\n"
            );
    ...
    if(overload0_called)
    {
        switch(arguments_received)
        {
            ...
            {
                #ifdef USE_WXPHP_DEBUG
                php_printf("Executing RETURN_LONG(wxTextInputStream::ReadDouble())\n\n");
                #endif

                if(current_object_type == PHP_WXTEXTINPUTSTREAM_TYPE)
                {
                    RETVAL_DOUBLE(((wxTextInputStream_php*)native_object)->ReadDouble());
                }
...
/* {{{ proto string wxTextInputStream::ReadLine() */
PHP_METHOD(php_wxTextInputStream, ReadLine)
{
    #ifdef USE_WXPHP_DEBUG
    php_printf("Invoking wxTextInputStream::ReadLine\n");
    php_printf("===========================================\n");
    #endif
    ...
    if(getThis() != NULL)
    {
        ...
        if(current_object->native_object == NULL)
        {
            zend_error(
                E_ERROR,
                "Failed to get the native object for "
                "wxTextInputStream::ReadLine call\n"
            );
    ...
    if(overload0_called)
    {
        switch(arguments_received)
        {
            ...
            {
                #ifdef USE_WXPHP_DEBUG
                php_printf("Executing RETURN_STRING(wxTextInputStream::ReadLine().fn_str(), 1)\n\n");
                #endif

                wxString value_to_return0;
                if(current_object_type == PHP_WXTEXTINPUTSTREAM_TYPE)
                {
                    value_to_return0 = ((wxTextInputStream_php*)native_object)->ReadLine();
                }
                RETVAL_STRING(value_to_return0.ToUTF8().data());
...
/* {{{ proto string wxTextInputStream::ReadWord() */
PHP_METHOD(php_wxTextInputStream, ReadWord)
{
    #ifdef USE_WXPHP_DEBUG
    php_printf("Invoking wxTextInputStream::ReadWord\n");
    php_printf("===========================================\n");
    #endif
    ...
    if(getThis() != NULL)
    {
        ...
        if(current_object->native_object == NULL)
        {
            zend_error(
                E_ERROR,
                "Failed to get the native object for "
                "wxTextInputStream::ReadWord call\n"
            );
    ...
    if(overload0_called)
    {
        switch(arguments_received)
        {
            ...
            {
                #ifdef USE_WXPHP_DEBUG
                php_printf("Executing RETURN_STRING(wxTextInputStream::ReadWord().fn_str(), 1)\n\n");
                #endif

                wxString value_to_return0;
                if(current_object_type == PHP_WXTEXTINPUTSTREAM_TYPE)
                {
                    value_to_return0 = ((wxTextInputStream_php*)native_object)->ReadWord();
                }
                RETVAL_STRING(value_to_return0.ToUTF8().data());
...
/* {{{ proto  wxTextInputStream::SetStringSeparators(string sep) */
PHP_METHOD(php_wxTextInputStream, SetStringSeparators)
{
    #ifdef USE_WXPHP_DEBUG
    php_printf("Invoking wxTextInputStream::SetStringSeparators\n");
    php_printf("===========================================\n");
    #endif
    ...
    if(getThis() != NULL)
    {
        ...
        if(current_object->native_object == NULL)
        {
            zend_error(
                E_ERROR,
                "Failed to get the native object for "
                "wxTextInputStream::SetStringSeparators call\n"
            );
    ...
    if(!already_called && arguments_received == 1)
    {
        #ifdef USE_WXPHP_DEBUG
        php_printf("Parameters received %d\n", arguments_received);
        php_printf("Parsing parameters with 's' (&sep0, &sep_len0)\n");
        #endif

        char parse_parameters_string[] = "s";
        if(zend_parse_parameters_ex(ZEND_PARSE_PARAMS_QUIET, arguments_received, parse_parameters_string, &sep0, &sep_len0 ) == SUCCESS)
        {
            overload0_called = true;
            already_called = true;
        }
    ...
    if(overload0_called)
    {
        switch(arguments_received)
        {
            ...
            {
                #ifdef USE_WXPHP_DEBUG
                php_printf("Executing wxTextInputStream::SetStringSeparators(wxString(sep0, wxConvUTF8))\n\n");
                #endif

                if(current_object_type == PHP_WXTEXTINPUTSTREAM_TYPE)
                {
                    ((wxTextInputStream_php*)native_object)->SetStringSeparators(wxString(sep0, wxConvUTF8));
                }
...
BEGIN_EXTERN_C()
void php_wxTextOutputStream_free(void *object)
{
    zo_wxTextOutputStream* custom_object = (zo_wxTextOutputStream*) object;

    #ifdef USE_WXPHP_DEBUG
    php_printf(
        "Calling php_wxTextOutputStream_free on %s at line %i\n",
        zend_get_executed_filename(),
        zend_get_executed_lineno()
    );
    php_printf("===========================================\n");
    ...
    if(custom_object->native_object != NULL)
    {
        ...
        #ifdef USE_WXPHP_DEBUG
        php_printf("Deletion of wxTextOutputStream done\n");
        php_printf("===========================================\n\n");
        #endif
    }
    else
...
zend_object* php_wxTextOutputStream_new(zend_class_entry *class_type)
{
    #ifdef USE_WXPHP_DEBUG
    php_printf(
        "Calling php_wxTextOutputStream_new on %s at line %i\n",
        zend_get_executed_filename(),
        zend_get_executed_lineno()
    );
    php_printf("===========================================\n");
    ...
    zo_wxTextOutputStream* custom_object;

    custom_object = (zo_wxTextOutputStream*) ecalloc(
        1,
        sizeof(zo_wxTextOutputStream)
        + zend_object_properties_size(class_type)
    );
    ...
    custom_object->zo.handlers = &wxphp_wxTextOutputStream_object_handlers;

    custom_object->native_object = NULL;
    custom_object->object_type = PHP_WXTEXTOUTPUTSTREAM_TYPE;
    custom_object->is_user_initialized = 0;
...
/* {{{ proto  wxTextOutputStream::Flush() */
PHP_METHOD(php_wxTextOutputStream, Flush)
{
    #ifdef USE_WXPHP_DEBUG
    php_printf("Invoking wxTextOutputStream::Flush\n");
    php_printf("===========================================\n");
    #endif

    zo_wxTextOutputStream* current_object;
    wxphp_object_type current_object_type;
    wxTextOutputStream_php* native_object;
    void* argument_native_object = NULL;
    ...
    if(getThis() != NULL)
    {
        current_object = Z_wxTextOutputStream_P(getThis());
        ...
        else
        {
            ...
            if(current_object_type == PHP_WXTEXTOUTPUTSTREAM_TYPE){
                references = &((wxTextOutputStream_php*)native_object)->references;
                reference_type_found = true;
            }
        }
    }
    ...
    if(overload0_called)
    {
        switch(arguments_received)
        {
            ...
            {
                #ifdef USE_WXPHP_DEBUG
                php_printf("Executing wxTextOutputStream::Flush()\n\n");
                #endif

                if(current_object_type == PHP_WXTEXTOUTPUTSTREAM_TYPE)
                {
                    ((wxTextOutputStream_php*)native_object)->Flush();
                }
    ...
    if(!already_called)
    {
        zend_error(
            E_ERROR,
            "Wrong type or count of parameters passed to: "
            "wxTextOutputStream::Flush\n"
        );
    }
}
/* }}} */

/* {{{ proto wxOutputStream wxTextOutputStream::GetOutputStream() */
PHP_METHOD(php_wxTextOutputStream, GetOutputStream)
{
    #ifdef USE_WXPHP_DEBUG
    php_printf("Invoking wxTextOutputStream::GetOutputStream\n");
    php_printf("===========================================\n");
    #endif
    ...
    if(getThis() != NULL)
    {
        ...
        if(current_object->native_object == NULL)
        {
            zend_error(
                E_ERROR,
                "Failed to get the native object for "
                "wxTextOutputStream::GetOutputStream call\n"
            );
    ...
    if(overload0_called)
    {
        switch(arguments_received)
        {
            ...
            {
                #ifdef USE_WXPHP_DEBUG
                php_printf("Executing wxTextOutputStream::GetOutputStream() to return object reference\n\n");
                #endif

                wxOutputStream_php* value_to_return0;
                if(current_object_type == PHP_WXTEXTOUTPUTSTREAM_TYPE)
                {
                    value_to_return0 = (wxOutputStream_php*) &((wxTextOutputStream_php*)native_object)->GetOutputStream();
                ...
                if(value_to_return0->references.IsUserInitialized()){
                    ...
                    object_init_ex(return_value,php_wxOutputStream_entry);
                    Z_wxOutputStream_P(return_value)->native_object = (wxOutputStream_php*) value_to_return0;
                }

                if((void*)value_to_return0 != (void*)native_object && return_is_user_initialized){ //Prevent adding references to it self
                    references->AddReference(return_value, "wxTextOutputStream::GetOutputStream at call 6 with 0 argument(s)");
                }
    ...
    if(!already_called)
    {
        zend_error(
            E_ERROR,
            "Wrong type or count of parameters passed to: "
            "wxTextOutputStream::GetOutputStream\n"
        );
    }
}
/* }}} */

/* {{{ proto wxEOL wxTextOutputStream::GetMode() */
PHP_METHOD(php_wxTextOutputStream, GetMode)
{
    #ifdef USE_WXPHP_DEBUG
    php_printf("Invoking wxTextOutputStream::GetMode\n");
    php_printf("===========================================\n");
    #endif
    ...
    if(getThis() != NULL)
    {
        ...
        if(current_object->native_object == NULL)
        {
            zend_error(
                E_ERROR,
                "Failed to get the native object for "
                "wxTextOutputStream::GetMode call\n"
            );
    ...
    if(overload0_called)
    {
        switch(arguments_received)
        {
            ...
            {
                #ifdef USE_WXPHP_DEBUG
                php_printf("Executing RETURN_LONG(wxTextOutputStream::GetMode())\n\n");
                #endif

                if(current_object_type == PHP_WXTEXTOUTPUTSTREAM_TYPE)
                {
                    RETVAL_LONG(((wxTextOutputStream_php*)native_object)->GetMode());
                }
...
/* {{{ proto  wxTextOutputStream::SetMode(wxEOL mode) */
PHP_METHOD(php_wxTextOutputStream, SetMode)
{
    #ifdef USE_WXPHP_DEBUG
    php_printf("Invoking wxTextOutputStream::SetMode\n");
    php_printf("===========================================\n");
    #endif
    ...
    if(getThis() != NULL)
    {
        ...
        if(current_object->native_object == NULL)
        {
            zend_error(
                E_ERROR,
                "Failed to get the native object for "
                "wxTextOutputStream::SetMode call\n"
            );
    ...
    if(overload0_called)
    {
        switch(arguments_received)
        {
            ...
            {
                #ifdef USE_WXPHP_DEBUG
                php_printf("Executing wxTextOutputStream::SetMode()\n\n");
                #endif

                if(current_object_type == PHP_WXTEXTOUTPUTSTREAM_TYPE)
                {
                    ((wxTextOutputStream_php*)native_object)->SetMode();
                }
            ...
            {
                #ifdef USE_WXPHP_DEBUG
                php_printf("Executing wxTextOutputStream::SetMode((wxEOL) mode0)\n\n");
                #endif

                if(current_object_type == PHP_WXTEXTOUTPUTSTREAM_TYPE)
                {
                    ((wxTextOutputStream_php*)native_object)->SetMode((wxEOL) mode0);
                }
...
/* {{{ proto  wxTextOutputStream::Write32(int i32) */
PHP_METHOD(php_wxTextOutputStream, Write32)
{
    #ifdef USE_WXPHP_DEBUG
    php_printf("Invoking wxTextOutputStream::Write32\n");
    php_printf("===========================================\n");
    #endif
    ...
    if(getThis() != NULL)
    {
        ...
        if(current_object->native_object == NULL)
        {
            zend_error(
                E_ERROR,
                "Failed to get the native object for "
                "wxTextOutputStream::Write32 call\n"
            );
    ...
    if(overload0_called)
    {
        switch(arguments_received)
        {
            ...
            {
                #ifdef USE_WXPHP_DEBUG
                php_printf("Executing wxTextOutputStream::Write32((wxUint32) i320)\n\n");
                #endif

                if(current_object_type == PHP_WXTEXTOUTPUTSTREAM_TYPE)
                {
                    ((wxTextOutputStream_php*)native_object)->Write32((wxUint32) i320);
                }
...
/* {{{ proto  wxTextOutputStream::Write16(int i16) */
PHP_METHOD(php_wxTextOutputStream, Write16)
{
    #ifdef USE_WXPHP_DEBUG
    php_printf("Invoking wxTextOutputStream::Write16\n");
    php_printf("===========================================\n");
    #endif
    ...
    if(getThis() != NULL)
    {
        ...
        if(current_object->native_object == NULL)
        {
            zend_error(
                E_ERROR,
                "Failed to get the native object for "
                "wxTextOutputStream::Write16 call\n"
            );
    ...
    if(overload0_called)
    {
        switch(arguments_received)
        {
            ...
            {
                #ifdef USE_WXPHP_DEBUG
                php_printf("Executing wxTextOutputStream::Write16((wxUint16) i160)\n\n");
                #endif

                if(current_object_type == PHP_WXTEXTOUTPUTSTREAM_TYPE)
                {
                    ((wxTextOutputStream_php*)native_object)->Write16((wxUint16) i160);
                }
...
/* {{{ proto  wxTextOutputStream::Write8(int i8) */
PHP_METHOD(php_wxTextOutputStream, Write8)
{
    #ifdef USE_WXPHP_DEBUG
    php_printf("Invoking wxTextOutputStream::Write8\n");
    php_printf("===========================================\n");
    #endif
    ...
    if(getThis() != NULL)
    {
        ...
        if(current_object->native_object == NULL)
        {
            zend_error(
                E_ERROR,
                "Failed to get the native object for "
                "wxTextOutputStream::Write8 call\n"
            );
    ...
    if(overload0_called)
    {
        switch(arguments_received)
        {
            ...
            {
                #ifdef USE_WXPHP_DEBUG
                php_printf("Executing wxTextOutputStream::Write8((wxUint8) i80)\n\n");
                #endif

                if(current_object_type == PHP_WXTEXTOUTPUTSTREAM_TYPE)
                {
                    ((wxTextOutputStream_php*)native_object)->Write8((wxUint8) i80);
                }
...
/* {{{ proto  wxTextOutputStream::WriteDouble(float f) */
PHP_METHOD(php_wxTextOutputStream, WriteDouble)
{
    #ifdef USE_WXPHP_DEBUG
    php_printf("Invoking wxTextOutputStream::WriteDouble\n");
    php_printf("===========================================\n");
    #endif
    ...
    if(getThis() != NULL)
    {
        ...
        if(current_object->native_object == NULL)
        {
            zend_error(
                E_ERROR,
                "Failed to get the native object for "
                "wxTextOutputStream::WriteDouble call\n"
            );
    ...
    if(!already_called && arguments_received == 1)
    {
        ...
        char parse_parameters_string[] = "d";
        if(zend_parse_parameters_ex(ZEND_PARSE_PARAMS_QUIET, arguments_received, parse_parameters_string, &f0 ) == SUCCESS)
        {
            overload0_called = true;
            already_called = true;
        }
    ...
    if(overload0_called)
    {
        switch(arguments_received)
        {
            ...
            {
                #ifdef USE_WXPHP_DEBUG
                php_printf("Executing wxTextOutputStream::WriteDouble(f0)\n\n");
                #endif

                if(current_object_type == PHP_WXTEXTOUTPUTSTREAM_TYPE)
                {
                    ((wxTextOutputStream_php*)native_object)->WriteDouble(f0);
                }
...
/* {{{ proto  wxTextOutputStream::WriteString(string string) */
PHP_METHOD(php_wxTextOutputStream, WriteString)
{
    #ifdef USE_WXPHP_DEBUG
    php_printf("Invoking wxTextOutputStream::WriteString\n");
    php_printf("===========================================\n");
    #endif
    ...
    if(getThis() != NULL)
    {
        ...
        if(current_object->native_object == NULL)
        {
            zend_error(
                E_ERROR,
                "Failed to get the native object for "
                "wxTextOutputStream::WriteString call\n"
            );
    ...
    if(overload0_called)
    {
        switch(arguments_received)
        {
            ...
            {
                #ifdef USE_WXPHP_DEBUG
                php_printf("Executing wxTextOutputStream::WriteString(wxString(string0, wxConvUTF8))\n\n");
                #endif

                if(current_object_type == PHP_WXTEXTOUTPUTSTREAM_TYPE)
                {
                    ((wxTextOutputStream_php*)native_object)->WriteString(wxString(string0, wxConvUTF8));
                }
