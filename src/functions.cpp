...
zval * wxphp_sprintf(INTERNAL_FUNCTION_PARAMETERS, int offset = 0)
{
    ...
    if (argc < 1) {
        zend_wrong_param_count(); return NULL;
    }
...
/* {{{ proto wxLinuxDistributionInfo wxGetLinuxDistributionInfo()
   Returns a structure containing information about the currently running Linux distribution. */
PHP_FUNCTION(php_wxGetLinuxDistributionInfo)
{
    #ifdef USE_WXPHP_DEBUG
    php_printf("Invoking function wxGetLinuxDistributionInfo\n");
    php_printf("===========================================\n");
    #endif
    ...
    if(overload0_called)
    {
        switch(arguments_received)
        {
            ...
            {
                #ifdef USE_WXPHP_DEBUG
                php_printf("Executing ::wxGetLinuxDistributionInfo() to return new object\n\n");
                #endif

                wxLinuxDistributionInfo value_to_return0;
                value_to_return0 = wxGetLinuxDistributionInfo();
                void* ptr = safe_emalloc(1, sizeof(wxLinuxDistributionInfo_php), 0);
                memcpy(ptr, (void*) &value_to_return0, sizeof(wxLinuxDistributionInfo));
                object_init_ex(return_value, php_wxLinuxDistributionInfo_entry);
                ((wxLinuxDistributionInfo_php*)ptr)->phpObj = *return_value;
                ((wxLinuxDistributionInfo_php*)ptr)->InitProperties();
                zo_wxLinuxDistributionInfo* zo0 = Z_wxLinuxDistributionInfo_P(return_value);
                zo0->native_object = (wxLinuxDistributionInfo_php*) ptr;
...
PHP_FUNCTION(php_wxDynamicCast)
{
    ...
    )
    {
        ...
        if(!strcmp(object_type, "wxWebRequestEvent"))
        {
            object_init_ex(return_value, php_wxWebRequestEvent_entry);
            wxWebRequestEvent* return_native_object = wxDynamicCast(
                native_object, wxWebRequestEvent_php
            );

            Z_wxWebRequestEvent_P(return_value)->native_object
                = (wxWebRequestEvent_php*) return_native_object
            ;
            return;
        }
        if(!strcmp(object_type, "wxWebViewFactory"))
        {
            object_init_ex(return_value, php_wxWebViewFactory_entry);
            wxWebViewFactory* return_native_object = wxDynamicCast(
                native_object, wxWebViewFactory_php
            );

            Z_wxWebViewFactory_P(return_value)->native_object
                = (wxWebViewFactory_php*) return_native_object
            ;
            return;
        }
        if(!strcmp(object_type, "wxView"))
        {
            object_init_ex(return_value, php_wxView_entry);
            wxView* return_native_object = wxDynamicCast(
                native_object, wxView_php
            );

            Z_wxView_P(return_value)->native_object
                = (wxView_php*) return_native_object
            ;
            return;
        }
        if(!strcmp(object_type, "wxTipWindow"))
        {
            object_init_ex(return_value, php_wxTipWindow_entry);
            wxTipWindow* return_native_object = wxDynamicCast(
                native_object, wxTipWindow_php
            );

            Z_wxTipWindow_P(return_value)->native_object
                = (wxTipWindow_php*) return_native_object
            ;
            return;
        }
        if(!strcmp(object_type, "wxTreeListEvent"))
        {
            object_init_ex(return_value, php_wxTreeListEvent_entry);
            wxTreeListEvent* return_native_object = wxDynamicCast(
                native_object, wxTreeListEvent_php
            );

            Z_wxTreeListEvent_P(return_value)->native_object
                = (wxTreeListEvent_php*) return_native_object
            ;
            return;
        }
        if(!strcmp(object_type, "wxTextUrlEvent"))
        {
            object_init_ex(return_value, php_wxTextUrlEvent_entry);
            wxTextUrlEvent* return_native_object = wxDynamicCast(
                native_object, wxTextUrlEvent_php
            );

            Z_wxTextUrlEvent_P(return_value)->native_object
                = (wxTextUrlEvent_php*) return_native_object
            ;
            return;
        }
        if(!strcmp(object_type, "wxArchiveFSHandler"))
        {
            object_init_ex(return_value, php_wxArchiveFSHandler_entry);
            wxArchiveFSHandler* return_native_object = wxDynamicCast(
                native_object, wxArchiveFSHandler_php
            );

            Z_wxArchiveFSHandler_P(return_value)->native_object
                = (wxArchiveFSHandler_php*) return_native_object
            ;
            return;
        }
        if(!strcmp(object_type, "wxAuiFloatingFrame"))
        {
            object_init_ex(return_value, php_wxAuiFloatingFrame_entry);
            wxAuiFloatingFrame* return_native_object = wxDynamicCast(
                native_object, wxAuiFloatingFrame_php
            );

            Z_wxAuiFloatingFrame_P(return_value)->native_object
                = (wxAuiFloatingFrame_php*) return_native_object
            ;
            return;
        }
        if(!strcmp(object_type, "wxAuiMDIChildFrame"))
        {
            object_init_ex(return_value, php_wxAuiMDIChildFrame_entry);
            wxAuiMDIChildFrame* return_native_object = wxDynamicCast(
                native_object, wxAuiMDIChildFrame_php
            );

            Z_wxAuiMDIChildFrame_P(return_value)->native_object
                = (wxAuiMDIChildFrame_php*) return_native_object
            ;
            return;
        }
        if(!strcmp(object_type, "wxAuiMDIClientWindow"))
        {
            object_init_ex(return_value, php_wxAuiMDIClientWindow_entry);
            wxAuiMDIClientWindow* return_native_object = wxDynamicCast(
                native_object, wxAuiMDIClientWindow_php
            );

            Z_wxAuiMDIClientWindow_P(return_value)->native_object
                = (wxAuiMDIClientWindow_php*) return_native_object
            ;
            return;
        }
        if(!strcmp(object_type, "wxAuiMDIParentFrame"))
        {
            object_init_ex(return_value, php_wxAuiMDIParentFrame_entry);
            wxAuiMDIParentFrame* return_native_object = wxDynamicCast(
                native_object, wxAuiMDIParentFrame_php
            );

            Z_wxAuiMDIParentFrame_P(return_value)->native_object
                = (wxAuiMDIParentFrame_php*) return_native_object
            ;
            return;
        }
        if(!strcmp(object_type, "wxColourDialogEvent"))
        {
            object_init_ex(return_value, php_wxColourDialogEvent_entry);
            wxColourDialogEvent* return_native_object = wxDynamicCast(
                native_object, wxColourDialogEvent_php
            );

            Z_wxColourDialogEvent_P(return_value)->native_object
                = (wxColourDialogEvent_php*) return_native_object
            ;
            return;
        }
        if(!strcmp(object_type, "wxFilterFSHandler"))
        {
            object_init_ex(return_value, php_wxFilterFSHandler_entry);
            wxFilterFSHandler* return_native_object = wxDynamicCast(
                native_object, wxFilterFSHandler_php
            );

            Z_wxFilterFSHandler_P(return_value)->native_object
                = (wxFilterFSHandler_php*) return_native_object
            ;
            return;
        }
        if(!strcmp(object_type, "wxGIFHandler"))
        {
            object_init_ex(return_value, php_wxGIFHandler_entry);
            wxGIFHandler* return_native_object = wxDynamicCast(
                native_object, wxGIFHandler_php
            );

            Z_wxGIFHandler_P(return_value)->native_object
                = (wxGIFHandler_php*) return_native_object
            ;
            return;
        }
        if(!strcmp(object_type, "wxGridStringTable"))
        {
            object_init_ex(return_value, php_wxGridStringTable_entry);
            wxGridStringTable* return_native_object = wxDynamicCast(
                native_object, wxGridStringTable_php
            );

            Z_wxGridStringTable_P(return_value)->native_object
                = (wxGridStringTable_php*) return_native_object
            ;
            return;
        }
        if(!strcmp(object_type, "wxIFFHandler"))
        {
            object_init_ex(return_value, php_wxIFFHandler_entry);
            wxIFFHandler* return_native_object = wxDynamicCast(
                native_object, wxIFFHandler_php
            );

            Z_wxIFFHandler_P(return_value)->native_object
                = (wxIFFHandler_php*) return_native_object
            ;
            return;
        }
        if(!strcmp(object_type, "wxIndividualLayoutConstraint"))
        {
            object_init_ex(return_value, php_wxIndividualLayoutConstraint_entry);
            wxIndividualLayoutConstraint* return_native_object = wxDynamicCast(
                native_object, wxIndividualLayoutConstraint_php
            );

            Z_wxIndividualLayoutConstraint_P(return_value)->native_object
                = (wxIndividualLayoutConstraint_php*) return_native_object
            ;
            return;
        }
        if(!strcmp(object_type, "wxInternetFSHandler"))
        {
            object_init_ex(return_value, php_wxInternetFSHandler_entry);
            wxInternetFSHandler* return_native_object = wxDynamicCast(
                native_object, wxInternetFSHandler_php
            );

            Z_wxInternetFSHandler_P(return_value)->native_object
                = (wxInternetFSHandler_php*) return_native_object
            ;
            return;
        }
        if(!strcmp(object_type, "wxJPEGHandler"))
        {
            object_init_ex(return_value, php_wxJPEGHandler_entry);
            wxJPEGHandler* return_native_object = wxDynamicCast(
                native_object, wxJPEGHandler_php
            );

            Z_wxJPEGHandler_P(return_value)->native_object
                = (wxJPEGHandler_php*) return_native_object
            ;
            return;
        }
        if(!strcmp(object_type, "wxNumberEntryDialog"))
        {
            object_init_ex(return_value, php_wxNumberEntryDialog_entry);
            wxNumberEntryDialog* return_native_object = wxDynamicCast(
                native_object, wxNumberEntryDialog_php
            );

            Z_wxNumberEntryDialog_P(return_value)->native_object
                = (wxNumberEntryDialog_php*) return_native_object
            ;
            return;
        }
        if(!strcmp(object_type, "wxNumericPropertyValidator"))
        {
            object_init_ex(return_value, php_wxNumericPropertyValidator_entry);
            wxNumericPropertyValidator* return_native_object = wxDynamicCast(
                native_object, wxNumericPropertyValidator_php
            );

            Z_wxNumericPropertyValidator_P(return_value)->native_object
                = (wxNumericPropertyValidator_php*) return_native_object
            ;
            return;
        }
        if(!strcmp(object_type, "wxPCXHandler"))
        {
            object_init_ex(return_value, php_wxPCXHandler_entry);
            wxPCXHandler* return_native_object = wxDynamicCast(
                native_object, wxPCXHandler_php
            );

            Z_wxPCXHandler_P(return_value)->native_object
                = (wxPCXHandler_php*) return_native_object
            ;
            return;
        }
        if(!strcmp(object_type, "wxPGArrayEditorDialog"))
        {
            object_init_ex(return_value, php_wxPGArrayEditorDialog_entry);
            wxPGArrayEditorDialog* return_native_object = wxDynamicCast(
                native_object, wxPGArrayEditorDialog_php
            );

            Z_wxPGArrayEditorDialog_P(return_value)->native_object
                = (wxPGArrayEditorDialog_php*) return_native_object
            ;
            return;
        }
        if(!strcmp(object_type, "wxPGArrayStringEditorDialog"))
        {
            object_init_ex(return_value, php_wxPGArrayStringEditorDialog_entry);
            wxPGArrayStringEditorDialog* return_native_object = wxDynamicCast(
                native_object, wxPGArrayStringEditorDialog_php
            );

            Z_wxPGArrayStringEditorDialog_P(return_value)->native_object
                = (wxPGArrayStringEditorDialog_php*) return_native_object
            ;
            return;
        }
        if(!strcmp(object_type, "wxPGEditorDialogAdapter"))
        {
            object_init_ex(return_value, php_wxPGEditorDialogAdapter_entry);
            wxPGEditorDialogAdapter* return_native_object = wxDynamicCast(
                native_object, wxPGEditorDialogAdapter_php
            );

            Z_wxPGEditorDialogAdapter_P(return_value)->native_object
                = (wxPGEditorDialogAdapter_php*) return_native_object
            ;
            return;
        }
        if(!strcmp(object_type, "wxPNGHandler"))
        {
            object_init_ex(return_value, php_wxPNGHandler_entry);
            wxPNGHandler* return_native_object = wxDynamicCast(
                native_object, wxPNGHandler_php
            );

            Z_wxPNGHandler_P(return_value)->native_object
                = (wxPNGHandler_php*) return_native_object
            ;
            return;
        }
        if(!strcmp(object_type, "wxPNMHandler"))
        {
            object_init_ex(return_value, php_wxPNMHandler_entry);
            wxPNMHandler* return_native_object = wxDynamicCast(
                native_object, wxPNMHandler_php
            );

            Z_wxPNMHandler_P(return_value)->native_object
                = (wxPNMHandler_php*) return_native_object
            ;
            return;
        }
        if(!strcmp(object_type, "wxPrintAbortDialog"))
        {
            object_init_ex(return_value, php_wxPrintAbortDialog_entry);
            wxPrintAbortDialog* return_native_object = wxDynamicCast(
                native_object, wxPrintAbortDialog_php
            );

            Z_wxPrintAbortDialog_P(return_value)->native_object
                = (wxPrintAbortDialog_php*) return_native_object
            ;
            return;
        }
        if(!strcmp(object_type, "wxRibbonToolBarEvent"))
        {
            object_init_ex(return_value, php_wxRibbonToolBarEvent_entry);
            wxRibbonToolBarEvent* return_native_object = wxDynamicCast(
                native_object, wxRibbonToolBarEvent_php
            );

            Z_wxRibbonToolBarEvent_P(return_value)->native_object
                = (wxRibbonToolBarEvent_php*) return_native_object
            ;
            return;
        }
        if(!strcmp(object_type, "wxSizerXmlHandler"))
        {
            object_init_ex(return_value, php_wxSizerXmlHandler_entry);
            wxSizerXmlHandler* return_native_object = wxDynamicCast(
                native_object, wxSizerXmlHandler_php
            );

            Z_wxSizerXmlHandler_P(return_value)->native_object
                = (wxSizerXmlHandler_php*) return_native_object
            ;
            return;
        }
        if(!strcmp(object_type, "wxTGAHandler"))
        {
            object_init_ex(return_value, php_wxTGAHandler_entry);
            wxTGAHandler* return_native_object = wxDynamicCast(
                native_object, wxTGAHandler_php
            );

            Z_wxTGAHandler_P(return_value)->native_object
                = (wxTGAHandler_php*) return_native_object
            ;
            return;
        }
        if(!strcmp(object_type, "wxTIFFHandler"))
        {
            object_init_ex(return_value, php_wxTIFFHandler_entry);
            wxTIFFHandler* return_native_object = wxDynamicCast(
                native_object, wxTIFFHandler_php
            );

            Z_wxTIFFHandler_P(return_value)->native_object
                = (wxTIFFHandler_php*) return_native_object
            ;
            return;
        }
        if(!strcmp(object_type, "wxXPMHandler"))
        {
            object_init_ex(return_value, php_wxXPMHandler_entry);
            wxXPMHandler* return_native_object = wxDynamicCast(
                native_object, wxXPMHandler_php
            );

            Z_wxXPMHandler_P(return_value)->native_object
                = (wxXPMHandler_php*) return_native_object
            ;
            return;
        }
        else
