...
/* {{{ proto wxPrintAbortDialog wxPrinter::CreateAbortWindow(wxWindow &parent, wxPrintout &printout)
...
PHP_METHOD(php_wxPrinter, CreateAbortWindow)
{
    ...
    if(getThis() != NULL)
    {
        ...
        if(current_object->native_object == NULL)
        {
            zend_error(
                E_ERROR,
                "Failed to get the native object for "
                "wxPrinter::CreateAbortWindow call\n"
            );
    ...
    if(!already_called && arguments_received == 2)
    {
        ...
        if(zend_parse_parameters_ex(ZEND_PARSE_PARAMS_QUIET, arguments_received, parse_parameters_string, &parent0, &printout0 ) == SUCCESS)
        {
            if(arguments_received >= 1){
                if(Z_TYPE_P(parent0) == IS_OBJECT)
                {
    ...
    if(overload0_called)
    {
        switch(arguments_received)
        {
            case 2:
            {
                ...
                wxPrintAbortDialog_php* value_to_return2;
                value_to_return2 = (wxPrintAbortDialog_php*) ((wxPrinter_php*)native_object)->CreateAbortWindow((wxWindow*) object_pointer0_0, (wxPrintout*) object_pointer0_1);
                ...
                if(value_to_return2 == NULL){
                    ...
                    Z_wxPrintAbortDialog_P(return_value)->native_object = (wxPrintAbortDialog_php*) value_to_return2;
                }

                if(Z_TYPE_P(return_value) != IS_NULL && (void*)value_to_return2 != (void*)native_object && return_is_user_initialized){
                    references->AddReference(return_value, "wxPrinter::CreateAbortWindow at call 5 with 2 argument(s)");
                }

                references->AddReference(parent0, "wxPrinter::CreateAbortWindow at call 1 with 2 argument(s)");
                references->AddReference(printout0, "wxPrinter::CreateAbortWindow at call 1 with 2 argument(s)");
