...
BEGIN_EXTERN_C()
void php_wxTextFile_free(void *object)
{
    zo_wxTextFile* custom_object = (zo_wxTextFile*) object;

    #ifdef USE_WXPHP_DEBUG
    php_printf(
        "Calling php_wxTextFile_free on %s at line %i\n",
        zend_get_executed_filename(),
        zend_get_executed_lineno()
    );
    php_printf("===========================================\n");
    ...
    if(custom_object->native_object != NULL)
    {
        ...
        #ifdef USE_WXPHP_DEBUG
        php_printf("Deletion of wxTextFile done\n");
        php_printf("===========================================\n\n");
        #endif
    }
    else
...
zend_object* php_wxTextFile_new(zend_class_entry *class_type)
{
    #ifdef USE_WXPHP_DEBUG
    php_printf(
        "Calling php_wxTextFile_new on %s at line %i\n",
        zend_get_executed_filename(),
        zend_get_executed_lineno()
    );
    php_printf("===========================================\n");
    ...
    zo_wxTextFile* custom_object;

    custom_object = (zo_wxTextFile*) ecalloc(
        1,
        sizeof(zo_wxTextFile)
        + zend_object_properties_size(class_type)
    );
    ...
    custom_object->zo.handlers = &wxphp_wxTextFile_object_handlers;

    custom_object->native_object = NULL;
    custom_object->object_type = PHP_WXTEXTFILE_TYPE;
    custom_object->is_user_initialized = 0;
...
/* {{{ proto string wxTextFile::GetLine(int n) */
PHP_METHOD(php_wxTextFile, GetLine)
{
    #ifdef USE_WXPHP_DEBUG
    php_printf("Invoking wxTextFile::GetLine\n");
    php_printf("===========================================\n");
    #endif

    zo_wxTextFile* current_object;
    wxphp_object_type current_object_type;
    wxTextFile_php* native_object;
    void* argument_native_object = NULL;
    ...
    if(getThis() != NULL)
    {
        current_object = Z_wxTextFile_P(getThis());
        ...
        else
        {
            ...
            if(current_object_type == PHP_WXTEXTFILE_TYPE){
                references = &((wxTextFile_php*)native_object)->references;
                reference_type_found = true;
            }
        }
    }
    ...
    if(!already_called && arguments_received == 1)
    {
        ...
        char parse_parameters_string[] = "l";
        if(zend_parse_parameters_ex(ZEND_PARSE_PARAMS_QUIET, arguments_received, parse_parameters_string, &n1 ) == SUCCESS)
        {
            overload1_called = true;
            already_called = true;
        }
    ...
    if(overload0_called)
    {
        switch(arguments_received)
        {
            ...
            {
                #ifdef USE_WXPHP_DEBUG
                php_printf("Executing RETURN_STRING(wxTextFile::GetLine((size_t) n0).fn_str(), 1)\n\n");
                #endif

                wxString value_to_return1;
                value_to_return1 = ((wxTextFile_php*)native_object)->GetLine((size_t) n0);
                RETVAL_STRING(value_to_return1.ToUTF8().data());
    ...
    if(overload1_called)
    {
        switch(arguments_received)
        {
            ...
            {
                #ifdef USE_WXPHP_DEBUG
                php_printf("Executing RETURN_STRING(wxTextFile::GetLine((size_t) n1).fn_str(), 1)\n\n");
                #endif

                wxString value_to_return1;
                value_to_return1 = ((wxTextFile_php*)native_object)->GetLine((size_t) n1);
                RETVAL_STRING(value_to_return1.ToUTF8().data());
...
/* {{{ proto  wxTextFile::wxTextFile() */
PHP_METHOD(php_wxTextFile, __construct)
{
    #ifdef USE_WXPHP_DEBUG
    php_printf("Invoking wxTextFile::__construct\n");
    php_printf("===========================================\n");
    #endif
    ...
    if(!already_called && arguments_received == 1)
    {
        #ifdef USE_WXPHP_DEBUG
        php_printf("Parameters received %d\n", arguments_received);
        php_printf("Parsing parameters with 's' (&strFile1, &strFile_len1)\n");
        #endif

        char parse_parameters_string[] = "s";
        if(zend_parse_parameters_ex(ZEND_PARSE_PARAMS_QUIET, arguments_received, parse_parameters_string, &strFile1, &strFile_len1 ) == SUCCESS)
        {
            overload1_called = true;
            already_called = true;
        }
    ...
    if(overload0_called)
    {
        switch(arguments_received)
        {
            case 0:
            {
                ...
                native_object = new wxTextFile_php();
    ...
    if(overload1_called)
    {
        switch(arguments_received)
        {
            ...
            {
                #ifdef USE_WXPHP_DEBUG
                php_printf("Executing __construct(wxString(strFile1, wxConvUTF8))\n");
                #endif

                native_object = new wxTextFile_php(wxString(strFile1, wxConvUTF8));
    ...
    else
    {
        zend_error(
            E_ERROR,
            "Abstract class or wrong type/count of parameters "
            "passed to: wxTextFile::__construct\n"
        );
    }
...
{
    #ifdef USE_WXPHP_DEBUG
    php_printf("Invoking wxTextFile::__get\n");
    php_printf("===========================================\n");
    #endif
...
/* {{{ proto  wxTextFile::AddLine(string str, wxTextFileType type) */
PHP_METHOD(php_wxTextFile, AddLine)
{
    #ifdef USE_WXPHP_DEBUG
    php_printf("Invoking wxTextFile::AddLine\n");
    php_printf("===========================================\n");
    #endif
    ...
    if(!already_called && arguments_received >= 1  && arguments_received <= 2)
    {
        #ifdef USE_WXPHP_DEBUG
        php_printf("Parameters received %d\n", arguments_received);
        php_printf("Parsing parameters with 's|l' (&str0, &str_len0, &type0)\n");
        #endif

        char parse_parameters_string[] = "s|l";
        if(zend_parse_parameters_ex(ZEND_PARSE_PARAMS_QUIET, arguments_received, parse_parameters_string, &str0, &str_len0, &type0 ) == SUCCESS)
        {
            overload0_called = true;
            already_called = true;
        }
    ...
    if(overload0_called)
    {
        switch(arguments_received)
        {
            ...
            {
                #ifdef USE_WXPHP_DEBUG
                php_printf("Executing wxTextFile::AddLine(wxString(str0, wxConvUTF8))\n\n");
                #endif

                ((wxTextFile_php*)native_object)->AddLine(wxString(str0, wxConvUTF8));
            ...
            {
                #ifdef USE_WXPHP_DEBUG
                php_printf("Executing wxTextFile::AddLine(wxString(str0, wxConvUTF8), (wxTextFileType) type0)\n\n");
                #endif

                ((wxTextFile_php*)native_object)->AddLine(wxString(str0, wxConvUTF8), (wxTextFileType) type0);
...
/* {{{ proto  wxTextFile::Clear() */
PHP_METHOD(php_wxTextFile, Clear)
{
    #ifdef USE_WXPHP_DEBUG
    php_printf("Invoking wxTextFile::Clear\n");
    php_printf("===========================================\n");
    #endif
    ...
    if(overload0_called)
    {
        switch(arguments_received)
        {
            ...
            {
                #ifdef USE_WXPHP_DEBUG
                php_printf("Executing wxTextFile::Clear()\n\n");
                #endif

                ((wxTextFile_php*)native_object)->Clear();
...
/* {{{ proto bool wxTextFile::Close() */
PHP_METHOD(php_wxTextFile, Close)
{
    #ifdef USE_WXPHP_DEBUG
    php_printf("Invoking wxTextFile::Close\n");
    php_printf("===========================================\n");
    #endif
    ...
    if(overload0_called)
    {
        switch(arguments_received)
        {
            ...
            {
                #ifdef USE_WXPHP_DEBUG
                php_printf("Executing RETURN_BOOL(wxTextFile::Close())\n\n");
                #endif

                RETVAL_BOOL(((wxTextFile_php*)native_object)->Close());
...
/* {{{ proto bool wxTextFile::Create() */
PHP_METHOD(php_wxTextFile, Create)
{
    #ifdef USE_WXPHP_DEBUG
    php_printf("Invoking wxTextFile::Create\n");
    php_printf("===========================================\n");
    #endif
    ...
    if(overload0_called)
    {
        switch(arguments_received)
        {
            ...
            {
                #ifdef USE_WXPHP_DEBUG
                php_printf("Executing RETURN_BOOL(wxTextFile::Create())\n\n");
                #endif

                RETVAL_BOOL(((wxTextFile_php*)native_object)->Create());
    ...
    if(overload1_called)
    {
        switch(arguments_received)
        {
            ...
            {
                #ifdef USE_WXPHP_DEBUG
                php_printf("Executing RETURN_BOOL(wxTextFile::Create(wxString(strFile1, wxConvUTF8)))\n\n");
                #endif

                RETVAL_BOOL(((wxTextFile_php*)native_object)->Create(wxString(strFile1, wxConvUTF8)));
...
/* {{{ proto bool wxTextFile::Eof() */
PHP_METHOD(php_wxTextFile, Eof)
{
    #ifdef USE_WXPHP_DEBUG
    php_printf("Invoking wxTextFile::Eof\n");
    php_printf("===========================================\n");
    #endif
    ...
    if(overload0_called)
    {
        switch(arguments_received)
        {
            ...
            {
                #ifdef USE_WXPHP_DEBUG
                php_printf("Executing RETURN_BOOL(wxTextFile::Eof())\n\n");
                #endif

                RETVAL_BOOL(((wxTextFile_php*)native_object)->Eof());
...
/* {{{ proto bool wxTextFile::Exists() */
PHP_METHOD(php_wxTextFile, Exists)
{
    #ifdef USE_WXPHP_DEBUG
    php_printf("Invoking wxTextFile::Exists\n");
    php_printf("===========================================\n");
    #endif
    ...
    if(overload0_called)
    {
        switch(arguments_received)
        {
            ...
            {
                #ifdef USE_WXPHP_DEBUG
                php_printf("Executing RETURN_BOOL(wxTextFile::Exists())\n\n");
                #endif

                RETVAL_BOOL(((wxTextFile_php*)native_object)->Exists());
...
/* {{{ proto int wxTextFile::GetCurrentLine() */
PHP_METHOD(php_wxTextFile, GetCurrentLine)
{
    #ifdef USE_WXPHP_DEBUG
    php_printf("Invoking wxTextFile::GetCurrentLine\n");
    php_printf("===========================================\n");
    #endif
    ...
    if(getThis() != NULL)
    {
        ...
        if(current_object->native_object == NULL)
        {
            zend_error(
                E_ERROR,
                "Failed to get the native object for "
                "wxTextFile::GetCurrentLine call\n"
            );
    ...
    if(overload0_called)
    {
        switch(arguments_received)
        {
            ...
            {
                #ifdef USE_WXPHP_DEBUG
                php_printf("Executing RETURN_LONG(wxTextFile::GetCurrentLine())\n\n");
                #endif

                RETVAL_LONG(((wxTextFile_php*)native_object)->GetCurrentLine());
...
/* {{{ proto string wxTextFile::GetFirstLine() */
PHP_METHOD(php_wxTextFile, GetFirstLine)
{
    #ifdef USE_WXPHP_DEBUG
    php_printf("Invoking wxTextFile::GetFirstLine\n");
    php_printf("===========================================\n");
    #endif
    ...
    if(overload0_called)
    {
        switch(arguments_received)
        {
            ...
            {
                #ifdef USE_WXPHP_DEBUG
                php_printf("Executing RETURN_STRING(wxTextFile::GetFirstLine().fn_str(), 1)\n\n");
                #endif

                wxString value_to_return0;
                value_to_return0 = ((wxTextFile_php*)native_object)->GetFirstLine();
                RETVAL_STRING(value_to_return0.ToUTF8().data());
...
/* {{{ proto string wxTextFile::GetLastLine() */
PHP_METHOD(php_wxTextFile, GetLastLine)
{
    #ifdef USE_WXPHP_DEBUG
    php_printf("Invoking wxTextFile::GetLastLine\n");
    php_printf("===========================================\n");
    #endif
    ...
    if(overload0_called)
    {
        switch(arguments_received)
        {
            ...
            {
                #ifdef USE_WXPHP_DEBUG
                php_printf("Executing RETURN_STRING(wxTextFile::GetLastLine().fn_str(), 1)\n\n");
                #endif

                wxString value_to_return0;
                value_to_return0 = ((wxTextFile_php*)native_object)->GetLastLine();
                RETVAL_STRING(value_to_return0.ToUTF8().data());
...
/* {{{ proto int wxTextFile::GetLineCount() */
PHP_METHOD(php_wxTextFile, GetLineCount)
{
    #ifdef USE_WXPHP_DEBUG
    php_printf("Invoking wxTextFile::GetLineCount\n");
    php_printf("===========================================\n");
    #endif
    ...
    if(overload0_called)
    {
        switch(arguments_received)
        {
            ...
            {
                #ifdef USE_WXPHP_DEBUG
                php_printf("Executing RETURN_LONG(wxTextFile::GetLineCount())\n\n");
                #endif

                RETVAL_LONG(((wxTextFile_php*)native_object)->GetLineCount());
...
/* {{{ proto wxTextFileType wxTextFile::GetLineType(int n) */
PHP_METHOD(php_wxTextFile, GetLineType)
{
    #ifdef USE_WXPHP_DEBUG
    php_printf("Invoking wxTextFile::GetLineType\n");
    php_printf("===========================================\n");
    #endif
    ...
    if(overload0_called)
    {
        switch(arguments_received)
        {
            ...
            {
                #ifdef USE_WXPHP_DEBUG
                php_printf("Executing RETURN_LONG(wxTextFile::GetLineType((size_t) n0))\n\n");
                #endif

                RETVAL_LONG(((wxTextFile_php*)native_object)->GetLineType((size_t) n0));
...
/* {{{ proto string wxTextFile::GetName() */
PHP_METHOD(php_wxTextFile, GetName)
{
    #ifdef USE_WXPHP_DEBUG
    php_printf("Invoking wxTextFile::GetName\n");
    php_printf("===========================================\n");
    #endif
    ...
    if(overload0_called)
    {
        switch(arguments_received)
        {
            ...
            {
                #ifdef USE_WXPHP_DEBUG
                php_printf("Executing RETURN_STRING(wxTextFile::GetName().fn_str(), 1)\n\n");
                #endif

                wxString value_to_return0;
                value_to_return0 = ((wxTextFile_php*)native_object)->GetName();
                RETVAL_STRING(value_to_return0.ToUTF8().data());
...
/* {{{ proto string wxTextFile::GetNextLine() */
PHP_METHOD(php_wxTextFile, GetNextLine)
{
    #ifdef USE_WXPHP_DEBUG
    php_printf("Invoking wxTextFile::GetNextLine\n");
    php_printf("===========================================\n");
    #endif
    ...
    if(overload0_called)
    {
        switch(arguments_received)
        {
            ...
            {
                #ifdef USE_WXPHP_DEBUG
                php_printf("Executing RETURN_STRING(wxTextFile::GetNextLine().fn_str(), 1)\n\n");
                #endif

                wxString value_to_return0;
                value_to_return0 = ((wxTextFile_php*)native_object)->GetNextLine();
                RETVAL_STRING(value_to_return0.ToUTF8().data());
...
/* {{{ proto string wxTextFile::GetPrevLine() */
PHP_METHOD(php_wxTextFile, GetPrevLine)
{
    #ifdef USE_WXPHP_DEBUG
    php_printf("Invoking wxTextFile::GetPrevLine\n");
    php_printf("===========================================\n");
    #endif
    ...
    if(overload0_called)
    {
        switch(arguments_received)
        {
            ...
            {
                #ifdef USE_WXPHP_DEBUG
                php_printf("Executing RETURN_STRING(wxTextFile::GetPrevLine().fn_str(), 1)\n\n");
                #endif

                wxString value_to_return0;
                value_to_return0 = ((wxTextFile_php*)native_object)->GetPrevLine();
                RETVAL_STRING(value_to_return0.ToUTF8().data());
...
/* {{{ proto  wxTextFile::GoToLine(int n) */
PHP_METHOD(php_wxTextFile, GoToLine)
{
    #ifdef USE_WXPHP_DEBUG
    php_printf("Invoking wxTextFile::GoToLine\n");
    php_printf("===========================================\n");
    #endif
    ...
    if(overload0_called)
    {
        switch(arguments_received)
        {
            ...
            {
                #ifdef USE_WXPHP_DEBUG
                php_printf("Executing wxTextFile::GoToLine((size_t) n0)\n\n");
                #endif

                ((wxTextFile_php*)native_object)->GoToLine((size_t) n0);
...
/* {{{ proto wxTextFileType wxTextFile::GuessType() */
PHP_METHOD(php_wxTextFile, GuessType)
{
    #ifdef USE_WXPHP_DEBUG
    php_printf("Invoking wxTextFile::GuessType\n");
    php_printf("===========================================\n");
    #endif
    ...
    if(overload0_called)
    {
        switch(arguments_received)
        {
            ...
            {
                #ifdef USE_WXPHP_DEBUG
                php_printf("Executing RETURN_LONG(wxTextFile::GuessType())\n\n");
                #endif

                RETVAL_LONG(((wxTextFile_php*)native_object)->GuessType());
...
/* {{{ proto  wxTextFile::InsertLine(string str, int n, wxTextFileType type) */
PHP_METHOD(php_wxTextFile, InsertLine)
{
    #ifdef USE_WXPHP_DEBUG
    php_printf("Invoking wxTextFile::InsertLine\n");
    php_printf("===========================================\n");
    #endif
    ...
    if(!already_called && arguments_received >= 2  && arguments_received <= 3)
    {
        #ifdef USE_WXPHP_DEBUG
        php_printf("Parameters received %d\n", arguments_received);
        php_printf("Parsing parameters with 'sl|l' (&str0, &str_len0, &n0, &type0)\n");
        #endif

        char parse_parameters_string[] = "sl|l";
        if(zend_parse_parameters_ex(ZEND_PARSE_PARAMS_QUIET, arguments_received, parse_parameters_string, &str0, &str_len0, &n0, &type0 ) == SUCCESS)
        {
            overload0_called = true;
            already_called = true;
        }
    ...
    if(overload0_called)
    {
        switch(arguments_received)
        {
            ...
            {
                #ifdef USE_WXPHP_DEBUG
                php_printf("Executing wxTextFile::InsertLine(wxString(str0, wxConvUTF8), (size_t) n0)\n\n");
                #endif

                ((wxTextFile_php*)native_object)->InsertLine(wxString(str0, wxConvUTF8), (size_t) n0);
            ...
            {
                #ifdef USE_WXPHP_DEBUG
                php_printf("Executing wxTextFile::InsertLine(wxString(str0, wxConvUTF8), (size_t) n0, (wxTextFileType) type0)\n\n");
                #endif

                ((wxTextFile_php*)native_object)->InsertLine(wxString(str0, wxConvUTF8), (size_t) n0, (wxTextFileType) type0);
...
/* {{{ proto bool wxTextFile::IsOpened() */
PHP_METHOD(php_wxTextFile, IsOpened)
{
    #ifdef USE_WXPHP_DEBUG
    php_printf("Invoking wxTextFile::IsOpened\n");
    php_printf("===========================================\n");
    #endif
    ...
    if(overload0_called)
    {
        switch(arguments_received)
        {
            ...
            {
                #ifdef USE_WXPHP_DEBUG
                php_printf("Executing RETURN_BOOL(wxTextFile::IsOpened())\n\n");
                #endif

                RETVAL_BOOL(((wxTextFile_php*)native_object)->IsOpened());
...
/* {{{ proto  wxTextFile::RemoveLine(int n) */
PHP_METHOD(php_wxTextFile, RemoveLine)
{
    #ifdef USE_WXPHP_DEBUG
    php_printf("Invoking wxTextFile::RemoveLine\n");
    php_printf("===========================================\n");
    #endif
    ...
    if(overload0_called)
    {
        switch(arguments_received)
        {
            ...
            {
                #ifdef USE_WXPHP_DEBUG
                php_printf("Executing wxTextFile::RemoveLine((size_t) n0)\n\n");
                #endif

                ((wxTextFile_php*)native_object)->RemoveLine((size_t) n0);
