...
/* {{{ proto  wxRibbonArtProvider::DrawTab(wxDC &dc, wxWindow &wnd, wxRibbonPageTabInfo tab)
   Draw a single tab in the tab region of a ribbon bar. */
void wxRibbonArtProvider_php::DrawTab(wxDC& dc, wxWindow* wnd, const wxRibbonPageTabInfo& tab)
{
    static zend_function* cached_function = NULL;
    static bool is_php_user_space_implemented = true;

    #ifdef USE_WXPHP_DEBUG
    php_printf("Invoking virtual wxRibbonArtProvider::DrawTab\n");
    php_printf("===========================================\n");
    #endif
    ...
    zval function_return_value;
    zval function_name;
    ZVAL_STRING(&function_name, "DrawTab");
    char* temp_string;
    void* return_object;
    int function_called;
    ...
    object_init_ex(&arguments[1], php_wxWindow_entry);
    Z_wxWindow_P(&arguments[1])->native_object = (wxWindow_php*) &wnd;
    object_init_ex(&arguments[2], php_wxRibbonPageTabInfo_entry);
    Z_wxRibbonPageTabInfo_P(&arguments[2])->native_object = (wxRibbonPageTabInfo_php*) &tab;
    ...
    #ifdef USE_WXPHP_DEBUG
    php_printf("Trying to call user defined method '%s'", "DrawTab");
...
PHP_METHOD(php_wxRibbonArtProvider, GetColor)
{
    ...
    if(getThis() != NULL)
    {
        ...
        else
        {
            ...
            if((current_object_type == PHP_WXRIBBONMSWARTPROVIDER_TYPE) && (!reference_type_found)){
                references = &((wxRibbonMSWArtProvider_php*)native_object)->references;
                reference_type_found = true;
            }
            if((current_object_type == PHP_WXRIBBONAUIARTPROVIDER_TYPE) && (!reference_type_found)){
                references = &((wxRibbonAUIArtProvider_php*)native_object)->references;
                reference_type_found = true;
            }
        }
    }
    ...
    if(overload0_called)
    {
        switch(arguments_received)
        {
            case 1:
            {
                ...
                if(current_object_type == PHP_WXRIBBONMSWARTPROVIDER_TYPE)
                {
                    value_to_return1 = ((wxRibbonMSWArtProvider_php*)native_object)->GetColor((int) id0);
                ...
                else if(current_object_type == PHP_WXRIBBONAUIARTPROVIDER_TYPE)
                {
                    value_to_return1 = ((wxRibbonAUIArtProvider_php*)native_object)->GetColor((int) id0);
                    ((wxRefCounter *) value_to_return1.GetRefData())->IncRef();
                    void* ptr = safe_emalloc(1, sizeof(wxColour_php), 0);
                    memcpy(ptr, (void*) &value_to_return1, sizeof(wxColour));
                    object_init_ex(return_value, php_wxColour_entry);
                ...
                else if(current_object_type == PHP_WXRIBBONARTPROVIDER_TYPE)
                {
    ...
    if(overload0_called)
    {
        switch(arguments_received)
        {
            case 2:
            {
                ...
                if(current_object_type == PHP_WXRIBBONMSWARTPROVIDER_TYPE)
                {
                    ((wxRibbonMSWArtProvider_php*)native_object)->SetColor((int) id0, *(wxColour*) object_pointer0_1);
                }
                else if(current_object_type == PHP_WXRIBBONAUIARTPROVIDER_TYPE)
                {
                    ((wxRibbonAUIArtProvider_php*)native_object)->SetColor((int) id0, *(wxColour*) object_pointer0_1);
                }
                else if(current_object_type == PHP_WXRIBBONARTPROVIDER_TYPE)
                {
...
bool wxRibbonArtProvider_php::GetButtonBarButtonSize(wxDC& dc, wxWindow* wnd, wxRibbonButtonKind kind, wxRibbonButtonBarButtonState size, const wxString& label, wxSize bitmap_size_large, wxSize bitmap_size_small, wxSize* button_size, wxRect* normal_region, wxRect* dropdown_region)
{
    ...
    Z_wxSize_P(&arguments[6])->native_object = (wxSize_php*) &bitmap_size_small;
    object_init_ex(&arguments[7], php_wxSize_entry);
    Z_wxSize_P(&arguments[7])->native_object = (wxSize_php*) &button_size;
    object_init_ex(&arguments[8], php_wxRect_entry);
    Z_wxRect_P(&arguments[8])->native_object = (wxRect_php*) &normal_region;
    object_init_ex(&arguments[9], php_wxRect_entry);
    Z_wxRect_P(&arguments[9])->native_object = (wxRect_php*) &dropdown_region;
        ...
        if(zend_parse_parameters_ex(ZEND_PARSE_PARAMS_QUIET, arguments_received, parse_parameters_string, &art0 ) == SUCCESS)
        {
            if(arguments_received >= 1){
                if(Z_TYPE_P(art0) == IS_OBJECT)
                {
                    ...
                    if (!object_pointer0_0 || (argument_type != PHP_WXRIBBONARTPROVIDER_TYPE && argument_type != PHP_WXRIBBONMSWARTPROVIDER_TYPE && argument_type != PHP_WXRIBBONAUIARTPROVIDER_TYPE))
                    {
        ...
        if(zend_parse_parameters_ex(ZEND_PARSE_PARAMS_QUIET, arguments_received, parse_parameters_string, &parent1, &id1, &pos1, php_wxPoint_entry, &size1, php_wxSize_entry, &style1, &validator1, &name1, &name_len1 ) == SUCCESS)
        {
            ...
            if(arguments_received >= 6){
                if(Z_TYPE_P(validator1) == IS_OBJECT)
                {
                    ...
                    if (!object_pointer1_5 || (argument_type != PHP_WXVALIDATOR_TYPE && argument_type != PHP_WXTEXTVALIDATOR_TYPE && argument_type != PHP_WXNUMERICPROPERTYVALIDATOR_TYPE && argument_type != PHP_WXGENERICVALIDATOR_TYPE))
                    {
...
PHP_METHOD(php_wxRibbonPanel, GetMinimisedIcon)
{
    ...
    if(overload1_called)
    {
        switch(arguments_received)
        {
            ...
            {
                #ifdef USE_WXPHP_DEBUG
                php_printf("Executing wxRibbonPanel::GetMinimisedIcon() to return new object\n\n");
                #endif

                wxBitmap value_to_return0;
                value_to_return0 = ((wxRibbonPanel_php*)native_object)->GetMinimisedIcon();
...
PHP_METHOD(php_wxRibbonToolBar, AddTool)
{
    ...
    if(!already_called && arguments_received >= 2  && arguments_received <= 6)
    {
        ...
        if(zend_parse_parameters_ex(ZEND_PARSE_PARAMS_QUIET, arguments_received, parse_parameters_string, &tool_id1, &bitmap1, php_wxBitmap_entry, &bitmap_disabled1, php_wxBitmap_entry, &help_string1, &help_string_len1, &kind1, &client_data1 ) == SUCCESS)
        {
            if(arguments_received >= 2){
                if(Z_TYPE_P(bitmap1) == IS_OBJECT)
                {
