...
PHP_METHOD(php_wxBookCtrlBase, Create)
{
    ...
    //Overload 1
    overload1:
    if(!already_called && arguments_received >= 1  && arguments_received <= 5 && (current_object_type == PHP_WXAUINOTEBOOK_TYPE || current_object_type == PHP_WXAUIMDICLIENTWINDOW_TYPE))
    {
        #ifdef USE_WXPHP_DEBUG
        php_printf("Parameters received %d\n", arguments_received);
...
PHP_METHOD(php_wxBookCtrlBase, AddPage)
{
    ...
    //Overload 1
    overload1:
    if(!already_called && arguments_received >= 2  && arguments_received <= 4 && (current_object_type == PHP_WXAUINOTEBOOK_TYPE || current_object_type == PHP_WXAUIMDICLIENTWINDOW_TYPE))
    {
        #ifdef USE_WXPHP_DEBUG
        php_printf("Parameters received %d\n", arguments_received);
    ...
    if(overload0_called)
    {
        switch(arguments_received)
        {
            case 1:
            {
                ...
                else if(current_object_type == PHP_WXAUIMDICLIENTWINDOW_TYPE)
                {
                    RETVAL_LONG(((wxAuiMDIClientWindow_php*)native_object)->HitTest(*(wxPoint*) object_pointer0_0));
                }
            ...
            case 2:
            {
                ...
                {
                    RETVAL_LONG(((wxAuiMDIClientWindow_php*)native_object)->HitTest(*(wxPoint*) object_pointer0_0, (long*) flags0));
                }
                else if(current_object_type == PHP_WXLISTBOOK_TYPE)
                {
    ...
    if(overload0_called)
    {
        switch(arguments_received)
        {
            case 1:
            {
                ...
                {
                    ((wxAuiMDIClientWindow_php*)native_object)->SetPageSize(*(wxSize*) object_pointer0_0);
                }
                else if(current_object_type == PHP_WXLISTBOOK_TYPE)
                {
